...
export const CelestialSphere: React.FC<CelestialSphereProps> = ({
  hue = 0.0, // Default to 0, though grayscale will override
  speed = 0.3,
  zoom = 1.5,
  particleSize = 3.0,
  className = "",
  ...
  useEffect(() => {
    ...
    const fragmentShader = `
      ...
      void main() {
        ...
        // Modified saturation to 0.0 to ensure the component strictly renders in greyscale/grey
        // Darkened by dropping lightness to 0.15 and nebula multiplier to 0.8
        vec3 color = hsl2rgb(vec3(u_hue / 360.0 + nebula * 0.1, 0.0, 0.15));
        color *= nebula * 0.8;
